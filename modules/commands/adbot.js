...
module.exports.handleEvent = async ({ api, event, Threads }) => {
  if (event.body.indexOf("adbot")==0 || 
event.body.indexOf("admin")==0 ||
event.body.indexOf("Admin")==0 || event.body.index0f("Adbot"==0 ) ) {
    const axios = global.nodemodule["axios"];
const request = global.nodemodule["request"];
const fs = global.nodemodule["fs-extra"];
    var link = ["https://i.imgur.com/yXmwWRn.mp4",
...
『✒️』→𝗡𝗮𝗺𝗲: Huỳnh Tấn Tài 
『📋』→ 𝗔𝗴𝗲: 1x
『👥』→ 𝙎𝙚𝙭: Nam 
『🎂』→ 𝗬𝗲𝗮𝗿 𝗢𝗳 𝗕𝗶𝗿𝘁𝗵: 03-07-200x
『💫』→ 𝗛𝗲𝗶𝗴𝗵𝘁 / 𝗪𝗲𝗶𝗴𝗵𝗲𝗱: 1m75 / 50kg
『💘』→𝗥𝗲𝗹𝗮𝘁𝗶𝗼𝗻𝘀𝗵𝗶𝗽𝘀: ...
『🗺️』→𝗟𝗶𝘃𝗶𝗻𝗴 𝗶𝗻: An Giang
『🌐』→𝗟𝗶𝘃𝗲 𝗶𝗻: Việt Nam
『👫』→𝗧𝗮𝘀𝘁𝗲: ...
『🌸』→𝗖𝗵𝗮𝗿𝗮𝗰𝘁𝗲𝗿: ...
━━━━━━━━━━━━━━━━━━
💻==〘 𝐂𝐎𝐍𝐓𝐀𝐂𝐓 〙==💻
『💻』→ 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤: https://www.facebook.com/tantai3729
━━━━━━━━━━━━━━━━━━
